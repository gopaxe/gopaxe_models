...
abstract class $PaysCopyWith<$Res> {
  ...
  @useResult
  $Res call({int paysId, String libelle});
}
...
class _$PaysImpl implements _Pays {
  const _$PaysImpl({required this.paysId, required this.libelle});
  ...
  @override
  String toString() {
    return 'Pays(paysId: $paysId, libelle: $libelle)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, paysId, libelle);
...
abstract class _Pays implements Pays {
  const factory _Pays(
      {required final int paysId, required final String libelle}) = _$PaysImpl;
